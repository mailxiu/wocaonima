            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="layui-form-pane m-t" id="frm" style="margin-top: 20px">
                        ...
                        <div class="form-group">
                            <label class="layui-form-label control-label label-required-next">充值积分：</label>
                            <div class="layui-input-inline">
                                <input id="rechargeMoney" name="rechargeMoney" class="layui-input" type="number">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="layui-form-label control-label ">赚送积分：</label>
                            <div class="layui-input-inline">
                                <input id="giveMoney" name="giveMoney" class="layui-input" type="number">
                            </div>
                        </div>
    ...
    $(document).ready(function () {
        $("#frm").validate({
            ...
            submitHandler: function (form) {
                ...
                let givMoney = $('#giveMoney').val();
                let username = $('#username').val();
                let isSend = false;
                let msg = givMoney?'您确定充值用户 【<span style="font-size: 20px;color:#4f93fe " >'+username+'</span>】  <span style="color: #c00000;font-size: 24px;"> '+rechargeMoney
                    +'</span> 积分,并赠送 <span style="color: #c00000;font-size: 24px;">'+givMoney+'</span> 积分吗？':
                    '您确定充值用户 【<span style="font-size: 24px;color:#4f93fe " >'+username+'</span>】 <span style="color: #c00000;font-size: 24px;">'+rechargeMoney+'</span> 积分吗？';
                layer.confirm(msg, {
                    title:username+'充值积分',
                    btn: ['确定', '取消'] //按钮
                }, function () {

                                ...
                                <div class="demoTable" style="margin-left: 50px">
                                    ...
                                    <%--</div>--%>
                                        ...
                                        <div class="layui-input-inline" style="margin-left: 10px;margin-top: 10px">
                                            <label>按类型</label>
                                            <div class="layui-input-inline ">
                                                <select class="selectpicker " data-width="100px"  id="type">
...
<script>
                   ...
                   /* {type: 'radio', fixed: 'left'},*/
                    ...
                    , {
                        ...
                        /*sort: true*/
                          templet: function (d) {
                              if(d.type=='管理员下分'){
                                  return '<span style="color: red">' +d.rechargeMoney + '</span>'
                              }
                              if(d.type=='管理员上分'){
                                  return '<span style="color:#4f93fe ">' +d.rechargeMoney + '</span>'
                              }
                              return d.rechargeMoney
    ...
    function getFlowWater(){
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.code==200) {
                    $('#yl').html('当前所有用户 总收入为：<span style="color: #c00000;font-size: 24px;">'+result.data.shouRu+'</span>'+
                        ',支出为：<span style="color: #c00000;font-size: 24px;">'+result.data.zhiChu+'</span>,'+
                    '利润为:<span style="color: #c00000;font-size: 24px;">'+result.data.liRun+'</span>')
                }
            }
        });
    }

...
/*    */ public class Stock implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.bss.entity.Stock)) return false;
        com.bss.entity.Stock other = (com.bss.entity.Stock) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.bss.entity.Stock;
    }


    public String toString() {
        return "Stock(id=" + getId() + ", merchant=" + getMerchant() + ", oid=" + getOid() + ", uid=" + getUid() + ", cid=" + getCid() + ", name=" + getName() + ", image=" + getImage() + ", points=" + getPoints() + ", code=" + getCode() + ", qrCode=" + getQrCode() + ", checkCode=" + getCheckCode() + ", state=" + getState() + ", createTime=" + getCreateTime() + ")";
    }
...
/* Location:              C:\Users\yang\Documents\xwechat_files\wxid_3fhkjy8fz0wc11_2b47\msg\file\2025-07\recovery_applet-1.0.3-SNAPSHOT.jar!\BOOT-INF\classes\com\bss\entity\Stock.class

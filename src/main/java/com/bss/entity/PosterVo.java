...
/*    */ public class PosterVo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof com.bss.entity.PosterVo)) return false;
        com.bss.entity.PosterVo other = (com.bss.entity.PosterVo) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof com.bss.entity.PosterVo;
    }


    public String toString() {
        return "PosterVo(md=" + getMd() + ", orient=" + getOrient() + ", state=" + getState() + ")";
    }
...
/* Location:              C:\Users\yang\Documents\xwechat_files\wxid_3fhkjy8fz0wc11_2b47\msg\file\2025-07\recovery_applet-1.0.3-SNAPSHOT.jar!\BOOT-INF\classes\com\bss\entity\PosterVo.class
